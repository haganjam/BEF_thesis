...
#' @title test_data
#' 
#' @description set-up a function to generate relevant test data for the different
#' partitions for two species in a single sample
#' 
#' @param S - sample id
#' @param M1 - monoculture function of species 1
#' @param M2 - monoculture function of species 2
#' @param Y1 - mixture function of species 1
#' @param Y2 - mixture function of species 2
#' 
